...
export function AppHeader({ userName }: { userName: string }) {
  ...
  return (
    <header className="z-20 flex h-12 shrink-0 items-center gap-3 border-b border-app-border bg-app-surface px-3 sm:h-14 md:sticky md:top-0 md:bg-app-surface/95 md:backdrop-blur-sm md:px-8">
      <nav
